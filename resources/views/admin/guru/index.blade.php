...
@section('content')
<div class="mb-4">
    <h1 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Kelola Data Guru</h1>
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tambah dan lihat daftar guru.</p>
</div>
...
<div class="flex flex-col sm:flex-row items-center justify-between mb-6 pb-4 border-b border-gray-200 dark:border-gray-700">
    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-0">Daftar Guru</h2>
    <button data-modal-target="crud-modal-guru" data-modal-toggle="crud-modal-guru" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 flex items-center" type="button">
...
<!-- Main modal -->
<div id="crud-modal-guru" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal-guru">
            ...
            <!-- Modal body -->
            <form action="{{ route('admin.guru.store') }}" method="POST" class="p-4 md:p-5" id="form-tambah-guru">
                @csrf
                ...
                <div class="grid gap-6 mb-4 grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="space-y-4">
                        <h4 class="text-md font-semibold text-gray-900 dark:text-white border-b pb-2 dark:border-gray-600">Informasi Guru</h4>

                        <div>
                        <label for="nama_lengkap" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Lengkap (S.Pd)</label>
                        <div class="relative">
                            ...
                            <input type="text" id="nama_lengkap" name="nama_lengkap" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Contoh: Budi Santoso, S.Pd" required>
                        </div>
                    </div>
                    
                    <div class="col-span-2">
                        <label for="nip" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NIP / ID Pegawai</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                            ...
                            <input type="text" id="nip" name="nip" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Nomor Induk Pegawai" required>
                        </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="id_kelas_wali" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wali Kelas</label>
                        <select id="id_kelas_wali" name="id_kelas_wali" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                            <option value="">Bukan Wali Kelas (Guru Spesialis)</option>
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Minimal 6 karakter" required minlength="6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative w-full aspect-square md:aspect-video bg-gray-900 rounded-lg overflow-hidden flex items-center justify-center shadow-inner border border-gray-300 dark:border-gray-600">
                            <!-- Video feed -->
                            <video id="guru-webcam" autoplay playsinline class="absolute top-0 left-0 w-full h-full object-cover transform scale-x-[-1] hidden"></video>
                            ...
                            <div id="webcam-starter" class="z-20 text-white flex flex-col items-center cursor-pointer hover:text-blue-400 group p-4 text-center transition-colors">
                                ...
                                <span class="text-xs text-gray-400 mt-1">Arahkan wajah guru ke kamera untuk pendaftaran.</span>
                            </div>
                        </div>
                ...
                <div class="mt-6 border-t pt-4 border-gray-200 dark:border-gray-600">
                    <button type="submit" id="btn-submit-guru" class="text-white inline-flex items-center w-full justify-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-colors">
...
<div class="flex flex-col mb-4 space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
    <div class="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0 text-sm">
        <form id="bulk-delete-form" action="{{ route('admin.guru.bulk_destroy') }}" method="POST" class="inline">
            @csrf
            @method('DELETE')
        ...
        <form action="{{ route('admin.guru.index') }}" method="GET" class="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0">
            <!-- Filter Mapel -->
            <select name="mapel" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full md:w-auto p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onchange="this.form.submit()">
    ...
    <div class="relative overflow-x-auto shadow-sm sm:rounded-lg">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tr>
                ...
                <th scope="col" class="px-6 py-3">Face ID Status</th>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                <td class="w-4 p-4">
                    <div class="flex items-center">
                        <input form="bulk-delete-form" id="checkbox-table-{{ $guru->id }}" type="checkbox" name="ids[]" value="{{ $guru->id }}" class="item-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="checkbox-table-{{ $guru->id }}" class="sr-only">checkbox</label>
                    </div>
                </td>
                ...
                <td class="px-6 py-4">
                    @if($guru->has_face_dataset)
                        <span class="inline-flex items-center bg-blue-100 text-blue-800 text-[10px] font-bold px-2 py-0.5 rounded-full dark:bg-blue-900 dark:text-blue-300">
                            <svg class="w-2.5 h-2.5 me-1" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/></svg>
                            AKTIF
                        </span>
                    @else
                        <span class="inline-flex items-center bg-gray-100 text-gray-400 text-[10px] font-bold px-2 py-0.5 rounded-full dark:bg-gray-700 dark:text-gray-500 italic">
                            BELUM SCAN
                        </span>
                    @endif
                </td>
                ...
                <td class="px-6 py-4 border-s dark:border-gray-700">
                    <div class="flex items-center space-x-3">
                        <!-- Tombol Edit -->
                        <button data-modal-target="edit-modal-guru-{{ $guru->id }}" data-modal-toggle="edit-modal-guru-{{ $guru->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline flex items-center" type="button">
                        ...
                        <!-- Form Hapus -->
                        <form action="{{ route('admin.guru.destroy', $guru->id) }}" method="POST" class="inline-block form-delete">
                            @csrf
                            @method('DELETE')
                    ...
                    <!-- Modal Edit Guru -->
                    <div id="edit-modal-guru-{{ $guru->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-[60] justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative p-4 w-full max-w-4xl max-h-full">
                            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                <div class="flex items-center justify-between p-4 border-b rounded-t dark:border-gray-600">
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Guru</h3>
                                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="edit-modal-guru-{{ $guru->id }}">
                                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/></svg>
                                        <span class="sr-only">Tutup modal</span>
                                    </button>
                                </div>
                                <form action="{{ route('admin.guru.update', $guru->id) }}" method="POST" class="p-4" id="form-edit-guru-{{ $guru->id }}">
                                    @csrf
                                    @method('PUT')
                                    <div id="edit-face-samples-container-{{ $guru->id }}"></div>
                                    <div class="grid gap-6 mb-4 grid-cols-1 md:grid-cols-2">
                                        <div class="space-y-4">
                                            <h4 class="text-md font-semibold text-gray-900 dark:text-white border-b pb-2 dark:border-gray-600">Informasi Guru</h4>
                                        <div class="col-span-2">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Lengkap</label>
                                            <input type="text" name="nama_lengkap" value="{{ $guru->user->nama_lengkap }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white" required>
                                        </div>
                                        <div class="col-span-2">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NIP / Username</label>
                                            <input type="text" name="nip" value="{{ $guru->nip }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white" required>
                                        </div>
                                        <div class="col-span-2 sm:col-span-1">
                                            ...
                                            <select name="mapel_ajar[]" multiple class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white h-24">
                                                ...
                                                @endphp
                                                @foreach($mapelOptions as $opt)
                                                    <option value="{{ $opt }}" {{ in_array($opt, $guruMapels) ? 'selected' : '' }}>{{ $opt }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-span-2 sm:col-span-1">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wali Kelas</label>
                                            <select name="id_kelas_wali" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                                                <option value="">Bukan Wali Kelas</option>
                                                @foreach($kelasOptions as $kls)
                                                    <option value="{{ $kls }}" {{ $guru->id_kelas_wali == $kls ? 'selected' : '' }}>{{ $kls }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-span-2">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kata Sandi Baru (Kosongkan jika tak diubah)</label>
                                            <div class="relative">
                                                <input type="password" id="edit-password-{{ $guru->id }}" name="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:text-white" minlength="6">
                                                <button type="button" class="password-toggle absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-blue-600 transition-colors" data-target="edit-password-{{ $guru->id }}">
                                                    <svg class="eye-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                                    <svg class="eye-off-icon w-5 h-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l18 18"/></svg>
                                                </button>
                                            </div>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="relative w-full aspect-square md:aspect-video bg-gray-900 rounded-lg overflow-hidden flex items-center justify-center shadow-inner border border-gray-300 dark:border-gray-600">
                                                <video id="edit-guru-webcam-{{ $guru->id }}" autoplay playsinline class="absolute top-0 left-0 w-full h-full object-cover transform scale-x-[-1] hidden"></video>
                                                
                                                <div id="edit-webcam-overlay-{{ $guru->id }}" class="absolute inset-x-0 inset-y-0 z-10 pointer-events-none flex items-center justify-center border-2 border-dashed border-white/50 rounded-xl px-12 py-10 m-6 hidden"></div>
                                                
                                                <div id="edit-webcam-starter-{{ $guru->id }}" class="edit-webcam-starter z-20 text-white flex flex-col items-center cursor-pointer hover:text-blue-400 group p-4 text-center transition-colors" data-id="{{ $guru->id }}">
                                                    <svg class="w-12 h-12 mb-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path></svg>
                                                    <span class="text-sm font-semibold">Klik untuk Aktifkan Kamera</span>
                                            ...
                                            <div>
                                                <div class="flex justify-between mb-1">
                                                    <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Sampel Baru (<span id="edit-sample-count-text-{{ $guru->id }}">0</span>/30)</span>
                                                    <span id="edit-camera-status-text-{{ $guru->id }}" class="text-xs font-medium text-gray-500">Kamera Offline</span>
                                                </div>
                                                <div class="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 overflow-hidden">
                                                    <div id="edit-sample-progress-bar-{{ $guru->id }}" class="bg-blue-600 h-2.5 rounded-full transition-all duration-300" style="width: 0%"></div>
                                                </div>
                                            </div>

                                            <button type="button" id="btn-start-record-edit-{{ $guru->id }}" data-id="{{ $guru->id }}" disabled class="btn-start-record-edit w-full text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // --- NEW CAMERA SCRIPT FOR ADMIN GURU REGISTRATION --- //
        const webcamStarter = document.getElementById('webcam-starter');
        const videoElement = document.getElementById('guru-webcam');
        ...
        const closeBtnObj = document.querySelectorAll('[data-modal-toggle="crud-modal-guru"]');
        ...
        editWebcamStarters.forEach(starter => {
            starter.addEventListener('click', async function() {
                ...
                const videoElement = document.getElementById(`edit-guru-webcam-${id}`);
        ...
        const editModalCloseBtns = document.querySelectorAll('[data-modal-toggle^="edit-modal-guru-"]');
        editModalCloseBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                // Note: to fully reset the UI for the specific modal, we could parse the ID from the button's data attribute
                // However, since we're using a full page reload on submit, just stopping the stream is usually enough to prevent camera light staying on.
            });
        });
    });
</script>
